...
export default function HomeScreen() {
    ...
    useEffect(()=>{
        ...
        Voice.onSpeechEnd = seepchEndHandler;
        ...
        Tts.addEventListener('tts-finish', (event) => {console.log("finish", event); speaking(false)});
            ...
            messages.length>0? (
                <View className="space-y-2 flex-1">
                    ...
                    <View style={{height: hp(58)}} className="bg-neutral-200 rounded-3xl p-4">
                        <ScrollView bounces={false} className="space-y-4" showsVerticalScrollIndicator={false} ref={ScrollViewRef}>
                            {
